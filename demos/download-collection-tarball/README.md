# demos/download-collection-tarball — Download a certified collection tarball from Automation Hub
...
| Setting | Value |
|---------|--------|
| Playbook | `demos/download-collection-tarball/playbook-aap.yml` |
...
```text
demos/download-collection-tarball/
├── README.md
