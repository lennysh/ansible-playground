# demos/ansible-filters — ansible.builtin filter reference
...
For stock **Jinja2** filters (`abs`, `map`, `join`, etc.) see [demos/jinja2-filters](../jinja2-filters/README.md).
...
- Compare `bool`, `ternary`, and Jinja2 truthiness pitfalls in [demos/when](../when/README.md).

## How to run

```bash
cd demos/ansible-filters
