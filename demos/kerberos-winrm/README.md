# demos/kerberos-winrm — Kerberos tickets when connecting to Windows over WinRM
...
Sync this repo (or `demos/kerberos-winrm/` subtree) into an AAP project.
...
```bash
less demos/kerberos-winrm/kerberos-diag-report.txt
```
