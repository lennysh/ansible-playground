# demos/dynamic-inventory — AAP inventory source YAML catalog
...
- [`demos/dynamic-inventory-with-static-vars`](../dynamic-inventory-with-static-vars/) — Proxmox + `group_vars` / `host_vars`
- [`demos/dynamic-inventory-merge`](../dynamic-inventory-merge/) — custom merge of flat INI/YAML/JSON
- [`demos/dynamic-inventory-csv`](../dynamic-inventory-csv/) — CSV-driven inventory plugin
...
3. **Sources → Add → Sourced from a Project**
   - Project: this repo
   - Source path: e.g. `demos/dynamic-inventory/example.aws_ec2.yml`
